...
(mf/defc viewport
  ...
  (let [;; When adding data from workspace-local revisit `app.main.ui.workspace` to check
        ...
        on-mouse-down     (actions/on-mouse-down @hover drawing-tool edition selected)
        ...
        show-selrect?            (and selrect (not drawing))]
    ...
    (hooks/setup-viewport-modifiers modifiers-stream modifiers selected objects render-ref)
